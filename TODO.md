...
- [x] collaborators should list individuals too, such as Hamlet Suárez (emérito SNI) - Added External Collaborators section
- [x] collaborators should have a former students section - Added with Juan Gandolfo, Melissa Imbert

## Pending (requires manual action)
- [ ] need pictures for research projects/lines
